...
If a change affects Docker, services, ports, storage, Supabase schema, archive worker behavior, cron/scheduled jobs, build output, or production env, update the Resource profile in `README.md` in the same change.
